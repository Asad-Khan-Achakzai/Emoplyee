...
/// This method will call the API for getProjectsList
/// it will get [employeeId] of type String? and
/// it will get [context] of type BuildContext as params
/// It will return the response from API
Future<dynamic> getProjectsList(
  String? employeeId,
  BuildContext context, {
  String? token,
}) async {
  String url = '${dotenv.env['BASEURL']}${ApiUrls.getProject}$employeeId';
  return callApi(
    url,
    context,
    token: token,
